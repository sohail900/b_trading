...
const SingleCategory = ({ slug }) => {
    ...
    const getSingleCatItem = async (page) => {
        ...
        try {
            ...
            if (MinMaxPrice?.min_price)
                params.min_price = MinMaxPrice?.min_price
            if (MinMaxPrice?.max_price)
                params.max_price = MinMaxPrice?.max_price
    ...
    }, [categoryIds, CurrentLanguage.code])
                                            ...
                                            Array.from({ length: 12 })?.map(
                                                (_, index) =>
                                                    view === 'list' ? (
                                                        ...
                                                        <div
                                                            className='col-xxl-3 col-lg-4 col-6'
                                                            key={index}
                                                        >
                                                            <ProductCardSkeleton />
                                                        </div>
