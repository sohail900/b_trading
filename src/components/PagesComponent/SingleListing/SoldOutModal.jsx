        ...
        >
            <div className='soldOutModal'>
                ...
                <div className='adItemDet'>
                    <Image
                        src={SingleListing?.image || placeholder_image}
                        width={72}
                        height={72}
                        alt='Ad Item'
                        className='adItemImg'
                    ...
                    <div className='adItemContent'>
                        ...
                        <span className='adItemPrice'>
                            {formatPriceAbbreviated(SingleListing?.price)}
                        </span>
                    </div>
                </div>
                <p className='selectBuyerFromList'>
                    {t('selectBuyerFromList')}
                </p>
                        ...
                        {Buyer.map((buyer, index) => (
                            <div className='adBuyersList' key={index}>
                                <div className='adBuyer'>
                                    <Image
                                        src={
                                            buyer?.profile || placeholder_image
                                        }
                                        width={48}
                                        height={48}
                                        alt='Ad Buyer'
                                        className='AdBuyerImg'
                                        onErrorCapture={placeholderImage}
                                    />
                                    <span className='adBuyerName'>
                                        {buyer?.name}
                                    </span>
                                </div>
                                <Radio
                                    className='soldOutRadio'
                                    value={buyer?.id}
                                    disabled={isNoneOfAboveChecked}
                                />
                            </div>
                        ))}
                    </Radio.Group>
                ...
                <div className='submitSoldOut'>
                    ...
                    <button
                        ...
                        className={`mrkAsSoldOut ${
                            isTransparent && 'apply_btn_transparent'
                        }`}
                    >
                        {t('soldOut')}
                    </button>
