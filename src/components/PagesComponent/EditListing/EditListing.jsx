...
const EditListing = ({ id }) => {
                    ...
                    if (fieldValue) {
                        setFilePreviews((prevPreviews) => ({
                            ...
                            [fieldId]: {
                                url: fieldValue[0],
                                isPdf: isPdf(
                                    extraField.custom_field_value.value
                                ),
                            },
                        }))
                    }
    ...
    }, [allCategoryIds, CurrentLanguage.code])
        ...
        for (const field of CustomFields) {
            ...
            if (required) {
                ...
                if (
                    ...
                    toast.error(
                        `${name} ${t('mustBeAtleast')} ${min_length} ${t(
                            'charactersLong'
                        )}`
                    )
                    return false
    ...
    const editAd = async () => {
        ...
        Object.entries(extraDetails).forEach(([key, value]) => {
            ...
            if (
                ...
                transformedCustomFields[key] = Array.isArray(value)
                    ? value
                    : [value]
            }
        })
