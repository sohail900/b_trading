...
const ChatUserTab = ({
    ...
    const userData = isBuyingTab
        ? selectedTabData?.seller
        : selectedTabData?.buyer
    const itemData = selectedTabData?.item
    const profileImage =
        userData?.profile || systemSettingsData?.data?.data?.placeholder_image
    const itemImage =
        itemData?.image || systemSettingsData?.data?.data?.placeholder_image
