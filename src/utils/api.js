...
export const frontendSettingsApi = {
    getFrontendSetting: ({ type, language_code } = {}) => {
        return Api.get(GET_FRONTEND_SETTINGS, {
            params: { type, language_code },
        })
    },
}
...
export const sliderApi = {
    getSlider: ({ language_code }) => {
        return Api.get(GET_SLIDER, {
            params: {
                language_code,
            },
        })
...
export const getCustomFieldsApi = {
    getCustomFields: ({ category_ids, language_code } = {}) => {
...
export const addItemApi = {
    addItem: ({
        ...
        if (show_only_to_premium)
            formData.append('show_only_to_premium', show_only_to_premium)
...
export const addReportReasonApi = {
    addReport: ({ item_id, report_reason_id, other_message } = {}) => {
        ...
        if (item_id) formData.append('item_id', item_id)
        if (report_reason_id)
            formData.append('report_reason_id', report_reason_id)
...
export const addReportReviewApi = {
    addReportReview: ({ seller_review_id, report_reason } = {}) => {
        ...
        // Append only if the value is defined and not an empty string
        if (seller_review_id)
            formData.append('seller_review_id', seller_review_id)
